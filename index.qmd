...
| 5 | [El inmueble como reserva de valor](reportes/report5-reserva-valor.qmd) | macro-zona | `housing_wealth` | A, T | publicado |
| 6 | [Profundidad financiera y morosidad por región](reportes/report6-financiera.qmd) | regional | `financial_depth` | M | publicado |
| 7 | [Estancamiento del sector dinámico](reportes/report7-sector-dinamico.qmd) | regional | `interregional_trade` | M, T, A | publicado |
| 8 | [El precio del dinero: tasas y apalancamiento](reportes/report8-tasas.qmd) | nacional | `tasas` | D, M, T, A | publicado |
...
- [Nota de familia: El inmueble como reserva de valor](briefings/briefing_housing_wealth.qmd)
...
- [Nota de familia: El precio del dinero: tasas y apalancamiento](briefings/briefing_tasas.qmd)
